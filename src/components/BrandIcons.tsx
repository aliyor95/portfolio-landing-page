...
// (GitHub, LinkedIn, Telegram) for trademark reasons, so we provide our own.
// The signature mirrors lucide icons: they accept a `className` prop.
...
export function TelegramIcon({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
      <path d="M23.91 3.79 20.3 20.84c-.25 1.21-.98 1.5-1.99.93l-5.5-4.07-2.66 2.57c-.3.3-.55.56-1.1.56l.38-5.56 10.12-9.15c.44-.39-.1-.61-.68-.22L6.27 13.5l-5.45-1.7c-1.18-.37-1.2-1.18.25-1.75l21.3-8.22c.98-.36 1.84.22 1.54 1.96Z" />
    </svg>
  )
}
